      ...
      <section className="relative z-10 py-16 md:py-20 lg:py-28">
        <div className="container">
          <SectionTitle
            ...
            paragraph="Watch this video to learn how our dedicated team can support you during the postpartum journey. Discover the steps to access our tailored services for mothers and their newborns."
            center
            mb="80px"
          />
        </div>
